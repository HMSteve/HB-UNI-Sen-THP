...
public:
    void init(uint8_t msgcnt, int16_t temp, uint8_t humidity, uint16_t airPressure, uint16_t batteryVoltage, bool batLow)
    {
...
public:
    ...
    virtual void trigger(AlarmClock& clock)
    {
        ...
        measure();
        msg.init(msgcnt, temperature10, humidity, airPressure10, batteryVoltage, device().battery().low());
